...
import sty from "./PlasmicButton.module.css"; // plasmic-import: v34VzxljCSke/css
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: eyzbVQoHo2Nf/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: RVXSS9djA5MC/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg___3TcX4)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__mbHhD)}
                role={"img"}
              />
            ),
