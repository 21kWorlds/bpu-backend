...
import sty from "./PlasmicUserSidePage.module.css"; // plasmic-import: 3gDeoVff23-u/css

createPlasmicElementProxy;

export const PlasmicUserSidePage__VariantProps = new Array();

export const PlasmicUserSidePage__ArgProps = new Array();
...
function PlasmicUserSidePage__RenderFunc(props) {
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) =>
          (() => {
            try {
              return new Date(
                new Date($queries.query.data[0].date).getTime() +
                  24 * 60 * 60 * 1000
              );
            } catch (e) {
              if (
  ...
  const new$Queries = {
    ...
    query2: usePlasmicDataOp(() => {
      return {
        sourceId: "4ACnaEgTThrwyGmam4pjE6",
        opId: "0d0adce2-f323-40a5-b567-83911221fc44",
        userArgs: {
          filters: [
            $queries.query.data[0].contactID,
            $queries.query.data[0].CatererID,
            $queries.query.data[0].OrgID
          ]
        },
        cacheKey: `plasmic.$.0d0adce2-f323-40a5-b567-83911221fc44.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    })
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <React.Fragment>
                              {(() => {
                                try {
                                  return $queries.query2.data[0].email;
                                } catch (e) {
                                  if (
                                    e instanceof TypeError ||
                                    e?.plasmicType ===
                          ...
                          >
                            <React.Fragment>
                              {(() => {
                                try {
                                  return $queries.query2.data[0].phoneNumber;
                                } catch (e) {
                                  if (
                                    e instanceof TypeError ||
                                    e?.plasmicType ===
                        ...
                        >
                          ...
                          <AntdSelect
                            ...
                            placeholder={"Select..."}
                            popupScopeClassName={sty["cateringPref__popup"]}
                            value={generateStateValueProp($state, [
                              "cateringPref",
                              "value"
                            ])}
                        ...
                        {(() => {
                          try {
                            return $state.cateringPref.value;
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                              e?.plasmicType === "PlasmicUndefinedDataError"
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicUserSidePage__ArgProps,
          internalVariantPropNames: PlasmicUserSidePage__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicUserSidePage__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicUserSidePage";
  } else {
    func.displayName = `PlasmicUserSidePage.${nodeName}`;
  }
  return func;
}
...
export const PlasmicUserSidePage = Object.assign(
  // Top-level PlasmicUserSidePage renders the root element
  withUsePlasmicAuth(withPlasmicPageGuard(makeNodeComponent("root"))),
  {
    ...
    // Metadata about props expected for PlasmicUserSidePage
    internalVariantProps: PlasmicUserSidePage__VariantProps,
    internalArgProps: PlasmicUserSidePage__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "",
      description: "",
...
export default PlasmicUserSidePage;
/* prettier-ignore-end */
