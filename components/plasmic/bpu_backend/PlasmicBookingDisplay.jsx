...
function PlasmicBookingDisplay__RenderFunc(props) {
      ...
      },
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) =>
          (() => {
            try {
              return (() => {
                const { id, booking_id, ...result } =
                  $queries.inquiries.data[0];
                return result;
              })();
            } catch (e) {
              if (
  ...
  const new$Queries = {
    ...
    lineItems: usePlasmicDataOp(() => {
      return {
        sourceId: "4ACnaEgTThrwyGmam4pjE6",
        opId: "fba76589-ad7b-47d1-af2e-1b73c178bb30",
        userArgs: {
          filters: [$props.booking.id]
        },
        cacheKey: `plasmic.$.fba76589-ad7b-47d1-af2e-1b73c178bb30.$.`,
        invalidatedKeys: null,
        roleId: null
      };
    }),
            ...
            >
              ...
              {(() => {
                ...
                return (
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__exTgm)}
                    >
                      <FormItemWrapper
                        className={classNames(
                          "__wab_instance",
                      ...
                      >
                        <AntdSelect
                          ...
                          options={(() => {
                            try {
                              return $queries.inventory.data.map(item => ({
                                value: item.id,
                                label: item.memo
                              }));
                            } catch (e) {
                      ...
                      {(() => {
                        try {
                          return $queries.inventory.data.find(
                            item => item.id === $state.form2.value.inventory_id
                          ).qty;
                        } catch (e) {
                          if (
                            e instanceof TypeError ||
                        ...
                        >
                          <AntdInputNumber
                            data-plasmic-name={"numberInput5"}
                            data-plasmic-override={overrides.numberInput5}
                            allowClear={true}
                            className={classNames(
                              "__wab_instance",
                              sty.numberInput5
                    ...
                    {(() => {
                      try {
                        return $state.checkbox5.checked;
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
                          e?.plasmicType === "PlasmicUndefinedDataError"
...
const PlasmicDescendants = {
  ...
  checkbox5: ["checkbox5"],
  input23: ["input23"],
  collapse: ["collapse", "input18", "input19", "numberInput"],
  input18: ["input18"],
  input19: ["input19"],
