...
import sty from "./PlasmicLinkPreview.module.css"; // plasmic-import: RaTKz2K_9ZYl/css
...
function PlasmicLinkPreview__RenderFunc(props) {
  ...
  return (
    ...
    >
      <DataCtxReader__>
        {$ctx => (
          <div className={classNames(projectcss.all, sty.freeBox___76Bj)}>
            <PlasmicImg__
            ...
            <div className={classNames(projectcss.all, sty.freeBox__iYizP)}>
              <div className={classNames(projectcss.all, sty.freeBox__fr1N5)}>
                <h5
