...
import Button from "../../Button"; // plasmic-import: v34VzxljCSke/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: jeKLErA7oK4P/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__wc008)}
              >
                <div
                  className={classNames(
                    projectcss.all,
