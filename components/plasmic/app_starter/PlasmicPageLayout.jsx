...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: x2bZy_YU1m2F/css
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: z0d4lWpvWIWq/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: puPXHFXRRCFt/icon
...
function PlasmicPageLayout__RenderFunc(props) {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__otg7Q)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___57UEx)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__zzin7)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__cxe9Y)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__v6Bzz)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
